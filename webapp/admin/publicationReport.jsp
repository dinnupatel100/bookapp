...
<center><h1>Report : Publication</h1></center>
<form>
<input name="pub" placeholder="Search Publication" style="width:150px;margin-left:500px;margin-top:20px;">
<button type="submit">Submit</button>
</form>
<%
	String cat = request.getParameter("pub");
	BookDAOImpl dao = new BookDAOImpl(DBConnect.getConn());
	List<BookDetails> list = dao.getPubReport(cat);
	int count = dao.getPubReportCount(cat);
%>
