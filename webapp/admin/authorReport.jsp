...
<center><h1>Report : Author</h1></center>
<form>
<input name="author" placeholder="Search Author name" style="width:150px;margin-left:500px;margin-top:20px;">
<button type="submit">Submit</button>
</form>
<%
	String cat = request.getParameter("author");
	BookDAOImpl dao = new BookDAOImpl(DBConnect.getConn());
	List<BookDetails> list = dao.getAuthorReport(cat);
	int count = dao.getAuthorReportCount(cat);
%>
