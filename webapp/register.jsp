...
<form action="register" method="post" onsubmit="return verifyPassword()">
    <div class="container" style="width:63vw; border-top:3px solid black ; height: 580px;">
        ...
        <div class="sign-up" style="float: right;">
                        ...
                        <font "> <a href="login.jsp" style="text-decoration: none; color : blue"> Sign in now </a></font>
       </div>
    </div>
</form>
</body>