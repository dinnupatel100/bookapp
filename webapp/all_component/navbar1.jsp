...
<div style="background-color: rgb(127, 255, 212); position: sticky; top: 0; width: 100%; z-index: 9;">
	<nav class="navbar navbar-expand-sm " style="margin-bottom: 0%;">
		...
		<c:if test="${userobj.type=='seller'}">
		<div class="col-sm-7  ">
			<ul class="navbar-nav">

				
				<li class="nav-item"><a class="nav-link" href="./sellBooks.jsp?email=${userobj.email}"><button
							style="background-color:red;border-radius:7px;margin-left:160px; height:35px;width:160px; border:none;background-color:#ff6666;">
							<i class="fa fa-upload"></i>  Sell Book</button></a>
				</li>
				<li class="nav-item "><a class="nav-link" style="color: black;margin-left:100px;margin-top:5px;"
					href="orders.jsp?email=${userobj.email}"><i class="fa fa-shopping-bag" aria-hidden="true"></i>
					 Orders</a></li>
				<li class="nav-item"><a class="nav-link" style="color: black;margin-left:40px; margin-top:5px;"
					href="./sellerbooks.jsp?email=${userobj.email}"><i class="fa fa-book" aria-hidden="true"></i>
					 All Books</a></li>
