...
<div style="display:flex ; position:relative;margin-bottom:40px;margin-top:50px;">
  ...
  <div style="width: 10vw;margin:1px auto 1px ">
    ...
    <div class="card-body" >
      <a href="view_books.jsp?bid=<%=b.getBookId()%>" class="card-link"><button style="background-color:rgb(240, 255, 255);">View Details</button></a>
...
<div style="display:flex ; position:relative;margin-bottom:40px;margin-top:50px;">
  <%
    ...
    List<BookDetails> list1 = dao1.getfreeBooks();
 ...
 <%} %>
     ...
     <a href="freeBooks.jsp"> <button style="background-color:rgb(252, 217, 222); border-radius:8mm; margin-left:85%;width:150px;">View all -></button></a>
<!--end card-FreeBooks-->
...
<div style="display:flex ; position:relative;margin-bottom:40px;margin-top:50px;">
  <%
    ...
    List<BookDetails> list2 = dao2.getPopularBooks();
  ...
  <div style="width: 10vw;margin:1px auto 1px ">
    ...
    <div class="card-body" >
      <a href="view_books.jsp?bid=<%=b2.getBookId()%>" class="card-link"><button style="background-color:rgb(240, 255, 255);">View Details</button></a>
      <a href="#" class="card-link" ><button style="background-color:rgb(127, 255, 212)">Buy Book</button></a>
 ...
 <%} %>
    ...
    <a href="popularBooks.jsp"> <button style="background-color:rgb(252, 217, 222); border-radius:8mm; margin-left:85%;width:150px;">View all</button></a>
